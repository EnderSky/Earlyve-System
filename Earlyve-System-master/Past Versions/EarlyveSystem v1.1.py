...
class AboutDialog ( wx.Dialog ):
        ...
        def __init__( self, parent ):
                ...
                self.textAbout = wx.StaticText( self, wx.ID_ANY, u"Earlyve System Version 1.1\n- Created by: Jotham Lim -\nCreated in wxFormBuilder", wx.DefaultPosition, wx.DefaultSize, 0 )
                self.textAbout.Wrap( -1 )
                bSizerAbout.Add( self.textAbout, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 20 )
                
                self.textFeatures = wx.StaticText( self, wx.ID_ANY, u"Features:\n- Allows user to input student ID of students who take early leave from school or are late for school\n- Stores this data into an Excel Workbook\n\nFuture Features:\n- Query By Date: Displays all data of a specified date\n- Query By Student ID: Displays all data corresponding \nto the specified Student ID\n- Allow user to select which Excel workbook \nto use to store data\n", wx.DefaultPosition, wx.DefaultSize, 0 )
                self.textFeatures.Wrap( -1 )
                bSizerAbout.Add( self.textFeatures, 0, wx.ALL, 5 )
...
class HelpDialog ( wx.Dialog ):
        ...
        def __init__( self, parent ):
                ...
                bSizerHelp.Add( self.textHelpTitle, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 15 )
                
                self.textHelpInstructions = wx.StaticText( self, wx.ID_ANY, u"1. Select appropriate header \"Early Leave\" or \"Latecomers\" \n    followed by \"Enter Student Data\"\n2. Click the cursor in the \"Student ID\" text field.\n3. Scan the barcode on the student's ID\n                   OR\n3. Enter the student's ID manually.\n4. Click the submit button.", wx.DefaultPosition, wx.DefaultSize, 0 )
                self.textHelpInstructions.Wrap( -1 )
                bSizerHelp.Add( self.textHelpInstructions, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 10 )
...
class UpdateLogDialog ( wx.Dialog ):
        ...
        def __init__( self, parent ):
                ...
                self.textHelpInstructions = wx.StaticText( self, wx.ID_ANY, u"v1.1\n- Updated \"About\" Page\n- Added \"Update Log\"\n- Fixed confirmation text\n- Now clears text field when data has been submitted\n\nv 1.0\n- Added \"About\" Page\n- Added \"Help\" Page\n- Added \"Exit Program\" Function\n- Added \"Enter Student Data\" function for both\n\"Early Leave\" and \"Latecomers\"", wx.DefaultPosition, wx.DefaultSize, 0 )
                self.textHelpInstructions.Wrap( -1 )
                bSizerUpdateLog.Add( self.textHelpInstructions, 0, wx.ALIGN_LEFT|wx.ALL, 10 )
