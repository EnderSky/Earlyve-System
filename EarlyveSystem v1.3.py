...
class MainFrame ( wx.Frame ):
        ...
        def __init__( self, parent ):
                ...
                self.textEnterStudentID.SetFont( wx.Font( 10, 70, 90, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
                bSizerMainFrame.Add( self.textEnterStudentID, 0, wx.ALL, 10 )
                
                self.textfieldStudentID = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, size = (-1, 150) )
                self.textfieldStudentID.SetFont( wx.Font( 100, 70, 90, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
