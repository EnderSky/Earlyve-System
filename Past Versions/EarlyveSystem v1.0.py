...
##   - Functions: OnSubmit, OnHelp, OnAbout, OnEarlyLeave, OnLatecomers
##   - Run Code
###########################################################################
...
class MainFrame ( wx.Frame ):
        ...
        def __init__( self, parent ):
                ...
                bSizerMainFrame.Add( self.textConfirmation, 0, wx.ALIGN_LEFT|wx.ALIGN_TOP|wx.ALL, 10 )
...
class AboutDialog ( wx.Dialog ):
        ...
        def __init__( self, parent ):
                wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"About", pos = wx.DefaultPosition, size = wx.Size( 250,150 ), style = wx.DEFAULT_DIALOG_STYLE )
                
                self.SetSizeHintsSz( wx.DefaultSize, wx.DefaultSize )
                
                bSizerAbout = wx.BoxSizer( wx.VERTICAL )
                
                self.textAbout = wx.StaticText( self, wx.ID_ANY, u"Earlyve System Version 1.0\n- Created by: Jotham Lim -\nCreated in wxFormBuilder", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class HelpDialog ( wx.Dialog ):
        ...
        def __init__( self, parent ):
                wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Help", pos = wx.DefaultPosition, size = wx.Size( 500,250 ), style = wx.DEFAULT_DIALOG_STYLE )
                ...
                bSizerHelp.Add( self.textHelpTitle, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 5 )
                ...
                bSizerHelp.Add( self.textHelpInstructions, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 20 )
